# Generated by Django 3.2.16 on 2024-03-06 17:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('size_foot', models.PositiveIntegerField(verbose_name='Размер обуви')),
                ('size_shirt', models.PositiveIntegerField(verbose_name='Размер одежды')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='merchorder', to='merch.order', verbose_name='Заказ')),
            ],
            options={
