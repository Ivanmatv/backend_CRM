...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('merch', '0001_initial'),
        ('content', '0002_auto_20240321_2129'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_end', models.DateTimeField(null=True, validators=[django.core.validators.MinValueValidator(limit_value=datetime.datetime(2024, 3, 21, 18, 29, 1, 385212, tzinfo=utc))], verbose_name='Дата окончания действия')),
